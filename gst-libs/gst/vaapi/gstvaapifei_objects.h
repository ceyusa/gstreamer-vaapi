...
gst_vaapi_enc_fei_mb_code_new (struct _GstVaapiEncoder * encoder,
...
GstVaapiEncFeiMv *
gst_vaapi_enc_fei_mv_new (struct _GstVaapiEncoder * encoder,
    gconstpointer param, guint param_size);
...
gst_vaapi_enc_fei_mv_predictor_new (struct _GstVaapiEncoder * encoder,
    gconstpointer param, guint param_size);
...
gst_vaapi_enc_fei_mb_control_new (struct _GstVaapiEncoder * encoder,
    gconstpointer param, guint param_size);
...
GstVaapiEncFeiQp *
gst_vaapi_enc_fei_qp_new (struct _GstVaapiEncoder * encoder,
    gconstpointer param, guint param_size);
...
gst_vaapi_enc_fei_distortion_new (struct _GstVaapiEncoder * encoder,
    gconstpointer param, guint param_size);
